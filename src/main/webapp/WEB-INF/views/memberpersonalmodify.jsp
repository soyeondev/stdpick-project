...
<body>
	...
	<!-- <span class="portlet-subtitle">개인 정보 입력</span> -->
			...
			<form action="modifyPersonal" id="F" method="post" name="frm" enctype="multipart/form-data">
				<div class="form-group" >
						<div class="md-form">
						  <i class="fas fa-user prefix"></i>
						  <input type="hidden" name="cust_no" value="${member.cust_no }">
						  <input type="text" style="width: 548.47px;" id="cust_name" name="cust_name" class="form-control" value="${member.cust_name}">
				...
				<div class="form-group" style="margin-bottom: 0px!important;">
					<div class="md-form" style="display: inline-block;">
						  <i class="fas fa-user prefix"></i>
						  <input type="text" style="width: 412px;" id="cust_nick" name="cust_nick" class="form-control"value="${member.cust_nick }">
					</div>
				...
				<div class="form-group">
						<div class="md-form">
						  ...
						  <input type="email"  style="width: 548.47px;" name="email" id="email" class="form-control" value="${member.email }">
						</div>
				</div>
				...
				<div class="form-group">
					<div class="md-form">
					  <i class="fas fa-lock prefix"></i>
					  <input type="password"  style="width: 548.47px; margin-bottom: 40px;" id="pwd1" name="pwd1" class="form-control validate" placeholder="비밀번호 확인">
					</div>
				</div>
