...
<body>
	...
	<div class="page-content" align="center">
		<div class="container-fluid">
			<form action="insertQa.do" method="post">
				<div class="bg-white table-responsive rounded shadow-sm mb-30"
					...
					<table class="table mb-0 table-bordered">
						<tr>
							...
							<td width="60%" colspan="4"><input type="text"
								...
								id="qa_title" name="qa_title"></td>
						<tr>
						<tr>
							<td class="qa" width="10%">작성자</td>
							<td width="40%">${c.cust_name}${p.pro_name}</td>
							<td class="qa" width="10%">문의일시</td>
							<td width="40%" ><input type="text" readonly="readonly"
								class="border0 qaTitle" style="width: 80%; height: 80%;"
								id="qa_write_date" name="qa_write_date" value="${sysdate}"></td>
						<tr>
						<tr>
					...
					<!-- 로그인한 고객정보 -->
					<input type="hidden"  id="cust_no" name="cust_no" value="0">
					<input type="hidden"  id="provider_no" name="provider_no" value="10">
					
					<input type="hidden" id="get_cust_no" name="get_cust_no" value="${c.cust_no}" >
					<input type="hidden" id="get_provider_no" name="get_provider_no" value="${p.provider_no}" >
				</div>
				<button class="btn btn-icon btn-outline-dark mb-2" type="submit" id="btnInsert" name="btnInsert">등록</button>
