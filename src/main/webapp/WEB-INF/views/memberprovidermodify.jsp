...
<script type="text/javascript">		
		function check1()	{
			var temp = $("#pro_nick").val();

			  $.ajax({		             
		            type : "POST",
		            url : "check_pro_nick.do",
		            data : { "pro_nick" : temp},
		...
		<script type="text/javascript">
				    ...
				    for (var i = 0, f; f = files[i]; i++) {
				      ...
				      reader.onload = (function(theFile) {
				        return function(e) {
				          ...
				          span.innerHTML = 
				          [
				            '<img style="width: 550px; height:300px; border: 0px solid gray; margin: 5px" src="', 
				            e.target.result,
			...
			function resetClick() {
				$("#imgs").empty();
				$("#btnReset").hide();
				var img = $('<img alt="" src="images/selPro2.png" id="selPro" width ="600px!important" style="cursor: pointer;">');
...
<body>
            ...
            <div class="container">
                <div class="row">
                    <div class=" col-md-8 ml-auto mr-auto">
                        <h1 class='text-uppercase'>사업자 회원가입 </h1>
	...
	<!-- <span class="portlet-subtitle">개인 정보 입력</span> -->
			...
			<form action="modifyProvider" id="F" method="post" name="frm" enctype="multipart/form-data">
				<div class="form-group" >
						<div class="md-form">
						  <i class="fas fa-user prefix"></i>
						  <input type="hidden" name="provider_no" value="${member.provider_no }">
						  <input type="text" style="width: 548.47px;" id="pro_name" name="pro_name" class="form-control" value="${member.pro_name }">
				...
				<div class="form-group" style="margin-bottom: 0px!important;">
					<div class="md-form" style="display: inline-block;">
						  <i class="fas fa-user prefix"></i>
						  <input type="text" style="width: 412px;" id="pro_nick" name="pro_nick" class="form-control" value="${member.pro_nick }">
					</div>
				...
				<div class="form-group">
					...
					<div class="md-form" style="display: inline-block;">
						  ...
						  <input type="tel" style="width: 548.47px;" id="phone" name="phone" class="form-control" value="${member.phone }" >
					</div>
				</div>
				...
				<div class="form-group">
						<div class="md-form">
						  ...
						  <input type="email"  style="width: 548.47px; margin-bottom: 40px;" name="email" id="email" class="form-control" value="${member.email }">
						</div>
				</div>
				<div class="form-group">
						<div class="md-form">
						  <i class="fas fa-home prefix"></i>
						  <input type="text"  style="width: 548.47px;" name="addr" id="addr"  class="form-control" value="${member.addr }">
						</div>
				</div>
				...
				<div class="form-group">
					<div class="md-form" style="display: inline-block;">
						  ...
						  <input type="text" style="width: 412px;" id="id" name="id"  class="form-control" value="${member.id }">
					</div>
				...
				<div class="form-group">
					<div class="md-form">
					  ...
					  <textarea name="pro_info"  style="width: 548.47px;" id="pro_info" class="md-textarea form-control" rows="3">${member.pro_info }</textarea>
					</div>
				</div>
				<div class="form-group">
				<output id="list"></output>
				<div id="imgs">
					<img alt="" src="images/selPro2.png" id="selPro" width ="600px!important" style="cursor: pointer;">
				</div>
					<input type="file" id="upload1" name="upload1" class="form-control" style="display: none; ">
					<input type="hidden" name="pro_img" value="${member.pro_img }">
					<input type="button" id="btnReset" value="다시선택" class="btn btn-outline-warning mr-1 mb-2" onClick="resetClick()"> 
				</div>
				</div>
				...
				<br>
				<div align="center">
				<input type="button" id="btnInsert" value="수정" class="btn btn-outline-warning mr-1 mb-2" onClick="goSubmit()"> <input id="resetBtn" type="reset" value="취소" class="btn btn-outline-warning mr-1 mb-2">
				</div>
				<br>
			</form>
			</div>
