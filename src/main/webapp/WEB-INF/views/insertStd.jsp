    ...
    <head>
        ...
        $(function(){
        	...
        	$("#insert_btn").click(function(){
        		$("#std_loc").val($("#sido option:selected").val()+"-"+$("#sigu option:selected").val());
        		var tags = $("#tags").val();
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light navbar-transparent bg-faded nav-sticky">
        ...
        <div class="white-page-content" style="padding-top: 5%">
            ...
            <div class="container pt5 pb40" style="padding-left: 5%;">
                ...
                <div class="row">
                    <div class="col-md-12 mb30">
                        <div class="single-prp-header mb40 clearfix">
							<h2 class="mb10 left-title">스투더 등록</h2>
                        </div>
                        <form id="std_form" method="POST" action="insertStd" enctype="multipart/form-data">
                          <input type="hidden" id="cust_no" name="founder_no" value="${loginVo.no }">
                        ...
                        <div class="prp-description pt50">
                            <div class="row" style="padding-left: 3%">
                                <div class="col-md-13 mb30">
                                    <ul class="list-unstyled summary">
                                        ...
                                        <li class="clearfix"><div class="float-right"><input type="text" name="std_name" style= "width:670px"></div>
                                            <i class="fa fa-address-card"></i> 스투더명
                                        </li>
                                        <li class="clearfix"><div class="float-right"><input type="text" name="std_intro" style= "width:670px"></div>
                                            <i class="fa fa-align-left"></i> 한줄소개
                                        </li>
                                        <li class="clearfix"><div class="float-right"><input type="text" name="std_time" style= "width:670px"></div>
                                            <i class="fa fa-check-circle"></i> 모임시간
                                        </li>
                                        <li class="clearfix">
                                        <i class="fa fa-map-marker"></i> 모임장소&nbsp;&nbsp;&nbsp;
		                                    <select name="sido" id="sido"></select>&nbsp;&nbsp;<select name="sigu" id="sigu"></select>
		                                    <input type="hidden" id="std_loc" name="std_loc">
                                        </li>
                                        <li class="clearfix"><div class="float-right"><input type="date" name="std_start" min="2019-01-01" max="2021-01-01" style= "width:670px"></div>
                                            <i class="fa fa-angle-double-right"></i> 시작일
                                        </li>
                                        <li class="clearfix"><div class="float-right"><input type="date" name="std_end" min="2019-01-01" max="2021-01-01" style= "width:670px"></div>
                                            <i class="fa fa-angle-double-left"></i> 종료일
                                        </li>
                                        <li class="clearfix"><div class="float-right"><input type="number" name="std_limit" style= "width:670px"></div>
                                            <i class="fa fa-user"></i> 모집인원
                                        </li>
                                        <li class="clearfix"><div class="float-right"><input type="date" name="std_close" min="2019-01-01" max="2021-01-01" style= "width:670px"></div>
                                            <i class="fa fa-exclamation-circle"></i> 모집마감일
                                        </li>
                              				<li class="clearfix">
                              			 <i class="fa fa-hashtag" style="margin-bottom: 2%;"></i> HashTag 
  	                            			<input type="text" id="tags" name="tags" style= "width:500px !important;" value="태그">
					                        <script type="text/javascript">
					                        	$('[name=tags]').tagify({duplicates :false});
					                        </script>
  	                            			<input type="hidden" id="tag_content" name="tag_content" style= "width:500px !important;" value="태그">
                                        </li>
                                        <li class="clearfix">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <textarea cols="120" rows="30" name="founder_info"></textarea>
                                </div>
                            </div>
                            <br><br>
                            <!--모임 소개-->
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <textarea cols="120" rows="30" name="std_content"></textarea>
                                </div>
                            </div>
                        </div>
                        </form>
  	                 	<div style="text-align: center;margin-bottom: 5%;margin-top: 5%"><a id="insert_btn" class=" btn btn-outline-warning mb5">등록</a></div> 
                    </div>
                </div>
            </div>
        </div>
