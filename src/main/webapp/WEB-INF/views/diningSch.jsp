...
<style type="text/css">
.markerbg {float:left;position:absolute;width:36px; height:37px;margin:10px 0 0 10px;background:url(http://t1.daumcdn.net/localimg/localimages/07/mapapidoc/marker_number_blue.png) no-repeat;}
...
<body>
	...
	<div style="border: solid 2px #D8D8D8; height: 9%;">
		<div class="show_loc">현재보고 있는 맛집 지역은&nbsp;&nbsp;</div><div class="diningLoc"><div id="centerAddr"></div></div><div style="float: left;margin-top: 1.5%;font-size: 15px;color: black;">&nbsp;&nbsp;입니다.</div>
	</div>
		...
		<div class="map_wrap">
	        ...
	        <span id="sch_lb" style="margin-left: 4%;margin-bottom: 2% !important;"></span>
	                ...
	                <input type="text" id="keyword"> 
	                   <button type="submit" id="btn_sch" class="btn btn-outline-warning mb5" style="width:120px !important; height:50px !important; padding: 0px !important;">검색하기</button>
	                </form>
	        </div><br>
		    <div id="map" style="width:90%;height:450px;margin-bottom:10px; margin-left:5%; overflow:hidden;"></div><br><br>
...
<script type="text/javascript" src="http://dapi.kakao.com/v2/maps/sdk.js?appkey=c1bc9ebf025c6c9764f3796dcc91b8d4&libraries=services"></script>
<script>
$(function(){});
	// list 페이지에서 보일 속성들
	$("#dining_board_s").hide();
	...
	function fnMove(idx) {
		...
		<div class="container pt100 pb70" id="dining_board">
			...
			<button type="button" id="back_btn" class="btn btn-outline-warning mb5" onclick="location.href='diningSch'">뒤로가기</button>
		</div>
	<!--Page content -->
