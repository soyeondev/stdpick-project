...
<body>
	...
	<!-- <span class="portlet-subtitle">개인 정보 입력</span> -->
			...
			<form action="insertProvider" id="F" method="post" name="frm" enctype="multipart/form-data">
				<div class="form-group" >
						<div class="md-form">
						  <i class="fas fa-user prefix"></i>
						  <input type="text" style="width: 548.47px;" id="pro_name" name="pro_name" class="form-control" placeholder="이름">
				...
				<div class="form-group" style="margin-bottom: 0px!important;">
					<div class="md-form" style="display: inline-block;">
						  <i class="fas fa-user prefix"></i>
						  <input type="text" style="width: 412px;" id="pro_nick" name="pro_nick" class="form-control" placeholder="닉네임">
					</div>
				...
				<div class="form-group">
					<div class="md-form" style="display: inline-block;">
						  ...
						  <input type="text" style="width: 412px;" id="id" name="id"  class="form-control" placeholder="아이디">
					</div>
				...
				<div class="form-group">
					<div class="md-form">
					  ...
					  <textarea name="pro_info"  style="width: 548.47px;" id="pro_info" class="md-textarea form-control" rows="3"></textarea>
					</div>
				</div>
				<div class="form-group">
