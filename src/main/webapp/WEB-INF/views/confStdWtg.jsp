...
<html>
    <head>
        ...
        $(function(){
        	...
        	$("#std_aprv").click(function(){
            	$.ajax({url:"updateAplyWtg.do?apply_no="+apply_no, 
            		success: function(){
                                ...
                                <div class="portlet-box portlet-gutter ui-buttons-col mb-30">
                                    ...
                                    <div class="portlet-body">
                                        <form>
                                            ...
                                            <div class="form-group row" style="margin-top: 2%; position: relative; left: 60px;">
                                                <div class="col-sm-2 ml-auto" style="display: inline; margin-right: 50%">
 		                                               	<input type="hidden" class="btn btn-primary btn-block"/>
                                                </div>
                                                <div class="col-sm-2 ml-auto" style="display: inline!important; padding: 0px; position: relative; left: 50px;">
                                                	<button id="std_ref" class="btn btn-warning mb5">거절</button>
                                                </div>
 		                                        <div class="col-sm-2 ml-auto" style="display: inline!important;padding: 0px;">
 		                                            <button  id="std_aprv" class="btn btn-warning mb5">승인</button>
                                                </div>
                                            </div>
