...
<html>
    ...
    /* 		$.getJSON("inqCount",{cafe_no:cafe_no},async:false,
    	...
    	/* 		$("a").click(function() {
    			...
    			$.getJSON("reviewList",{"cafe_no":cafe_no, "start":reviewStart, "end":reviewEnd }, function(data) {
    					...
    					$.each(data, function(idx, vo) {
    						...
    						if(vo.review_reply != null){
    							...
    							var revRep = $('<div id="inqRep" class="inqReply">');
    							
	    						var span = $('<span><font id="manager" style="font-weight: bold; margin-bottom: 5px; color: orange; font-size: 16px">'+cafe_name+' 관리자</font></span><br>');
	    						
	    						var icon = $('<i class="fas fa-reply fa-rotate-180" style="width: 30px; height: 30px; margin-top: 0px; position: relative; top: -15px;" ></i><br>');
	    						
	    						var reply = $(' <div class="md-form amber-textarea active-amber-textarea-2 " style="width: 1000px;"></div>');
	    						var ic = $('<i class="fas fa-angle-double-right prefix"></i>');
	    						var txtarea = $(' <textarea id="form25"  class="md-textarea form-control" rows="3" cols="70" style="width: 800px; display: inline; re"></textarea>');
	    						var repBtn = $('<button id="reviewInsertBtn" class="btn btn-outline-warning mb5" style="position: relative; top: -30px; left: 20px;">등록</button>');
	    						var repLab = $('<label for="form25">　답변을 남겨주세요</label>');
	    						$(reply).append(ic,txtarea,repBtn,repLab);
	    						
	    						$(revRep).append(hr2,span,icon,reply);
    					
	    						$(mediabody).append(revRep);
    				
    							$(revRep).hide();
    							
    							var revRepBtn = $('<button id="inqReplyBtn" class="btn btn-outline-warning mb5" style="position: relative; height: 40px;">답글 남기기</button>');
    					
    							$(mediabody).append(revRepBtn);
    							
    							$(revRepBtn).click(function(){
    							...
    							$(repBtn).click(function(){
    								...
    								var replyMg = $('<span style="position: relative; left: 40px; top: -30px;">'+text+'</span>');
    								$(revRep).append(replyMg);
    	    				
    	    					  	$.ajax({
    	    					 		url:"updateReview",
    	    					 		data:{"text":text,"review_no":review_no},
    	    					 		success:function(data){
    		...
    		var listAllInq = function(cafe_no, start, end) {
    		 	$("#inqContent").empty();
    		 	var cafe_name = $("#cafename").val();
    			$.getJSON("inqAllList",{"cafe_no":cafe_no, "start":start, "end":end }, function(data) {
    					$.each(data, function(idx, vo) {
    						...
    						if(vo.inq_reply != null){
    							...
    							var inqRep = $('<div id="inqRep" class="inqReply">');
    							
	    						var span = $('<span><font id="manager" style="font-weight: bold; margin-bottom: 5px; color: orange; font-size: 16px">'+cafe_name+' 관리자</font></span><br>');
	    						
	    						var icon = $('<i class="fas fa-reply fa-rotate-180" style="width: 30px; height: 30px; margin-top: 0px; position: relative; top: -15px;" ></i><br>');
	    						
	    						var reply = $(' <div class="md-form mb-4 pink-textarea active-pink-textarea-2" style="width: 1000px;"></div>');
	    						var ic = $('<i class="fas fa-angle-double-right prefix"></i>');
	    						var txtarea = $(' <textarea id="form25"  class="md-textarea form-control" rows="3" cols="70" style="width: 800px; display: inline; re"></textarea>');
	    						var repBtn = $('<button id="inqInsertBtn" class="btn btn-outline-primary mb5" style="position: relative; top: -30px; left: 20px;">등록</button>');
	    						var repLab = $('<label for="form25">　답변을 남겨주세요</label>');
	    						$(reply).append(ic,txtarea,repBtn,repLab);
	    						
	    						$(inqRep).append(hr2,span,icon,reply);
    					
	    						$(mediabody).append(inqRep);
    				
    							$(inqRep).hide();
    							
    							var inqRepBtn = $('<button id="inqReplyBtn" class="btn btn-outline-primary mb5" style="position: relative; height: 40px;">답글 남기기</button>');
    					
    							$(mediabody).append(inqRepBtn);
    							
    							$(inqRepBtn).click(function(){
    							...
    							$(repBtn).click(function(){
    								...
    								var text = $(txtarea).val();
    								var inq_no = vo.inq_no;
    								
    								
    								var replyMg = $('<span style="position: relative; left: 40px; top: -30px;">'+text+'</span>');
    								$(inqRep).append(replyMg);
    	    				
    	    					 	$.ajax({
    	    					 		url:"updateInq",
    	    					 		data:{"text":text,"inq_no":inq_no},
    	    					 		success:function(data){
            ...
            <div class="col-lg-9 ml-auto mb30 sticky-content course-detail">
                ...
                <div style="position:relative;height:0;padding-bottom:40.25%">
                    ...
                    <div style="position: relative; left: 550px; top: -400px;">
						...
						<!-- 버튼 -->
						<button type="button" class="btn btn-outline-warning mb5" style="margin-top: 5px; margin-right: 10px;">룸 예약하기</button>
						<button type="button" class="btn btn-outline-warning mb5" style="margin-top: 5px; margin-right: 10px;">이용권 구매</button>
                        ...
                        <div class="tab-pane active show" id="c-desc">
                            <div class="row">
                                ...
                                <div class="col-md-4 mb-30">
                                    ...
                                    <br>
                                    <a href="https://goo.gl/maps/oqwoQqFMZ12qXaWs6" target="_blank" class="btn btn-outline-warning mb5">
                            ...
                            <div class="media clearfix" style="margin-top: 10px;">
                                ...
                                <div class="media-body border-bottom">
                                  ...
                                  <div class="md-form mb-4 pink-textarea active-pink-textarea-2" style="width: 1000px;">
									  ...
									  <textarea id="form23" readonly="readonly" class="md-textarea form-control" rows="3" cols="70" style="width: 800px; display: inline; re"></textarea>
									  <button id="inqInsertBtn" disabled="disabled" class="btn btn-outline-primary mb5" style="position: relative; top: -30px; left: 20px;">등록</button>
									  <label for="form23">　　사업자는 문의를 남기실 수 없습니다</label>
								</div>
                                </div>
                            </div><!--/.review-->
                             ...
                             <div  class="media clearfix" style="margin-top: 10px;">
                                ...
                                <div class="media-body border-bottom">
                                    <h6>${inqvo.cust_nick }</h6>
                                           	...
                                           	${inqvo.inq_content }<br> <button id="inqReplyBtn" class="btn btn-outline-primary mb5" style="position: relative; height: 40px;">답글 남기기</button>
                                           	<hr style="margin-bottom: 0px!important">
                                           	<c:if test="${!empty inqvo.inq_reply  }">
                                           	<div id="inqRep" class="inqReply" style="position: relative; left: 40px; top: -30px;">
	                                           	...
	                                           	<i class="fas fa-reply fa-rotate-180" style="width: 30px; height: 30px; margin-top: 0px; position: relative; top: -15px;" ></i><br>
	                                           		 ...
	                                           		 <div class="md-form mb-4 pink-textarea active-pink-textarea-2" style="width: 1000px;">
														  <i class="fas fa-angle-double-right prefix"></i>
														  <textarea id="form25"  class="md-textarea form-control" rows="3" cols="70" style="width: 800px; display: inline; re"></textarea>
														  <button id="inqInsertBtn" class="btn btn-outline-primary mb5" style="position: relative; top: -30px; left: 20px;">등록</button>
														  <label for="form25">　답변을 남겨주세요</label>
													</div>
	                                           	</div>
                                           	</c:if>
                            ...
                            <div class="media clearfix" style="margin-top: 10px;">
                                ...
                                <div class="media-body border-bottom">
                                  ...
                                  <div class="md-form amber-textarea active-amber-textarea-2" style="width: 1000px;">
									  ...
									  <textarea id="form24" readonly="readonly" class="md-textarea form-control" rows="3" cols="70" style="width: 800px; display: inline;"></textarea>
									  <button id="reviewAddBtn" disabled="disabled" class="btn btn-outline-warning mb5" style="position: relative; top: -30px; left: 20px;">등록</button>
								 	  <label for="form24">　사업자는 리뷰를 남기 실 수 없습니다</label>
                         ...
                         <div class="tab-pane" id="c-cancle" style="width: 1200px;">
                            <div class="row">
                                <div class="col-md-8 mb-30" style="width: 1200px;">
                                    ...
                                    <hr>
                                    <p>
                                        <font class="info">${cafe.cafe_policy }</font><br>
