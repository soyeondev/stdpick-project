...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light navbar-transparent bg-faded nav-sticky">
            ...
            <div class="container">
                <div class="row">
                    <div class=" col-md-8 ml-auto mr-auto">
                        <h1 class='text-uppercase'>회원가입 완료 </h1>
        ...
        <!-- 요기에 넣어!!!!!-->
        		...
        		<div align="center">
        				<img src="images/page_join_img.jpg">
				</div>
        		 <div class="pt-20 text-center">
        		 <br>
			<a href="index.do"><button  class="btn btn-outline-primary mr-1 mb-2">메인으로</button></a>
			<a href="/login"><button class="btn btn-outline-primary mr-1 mb-2">로그인</button></a>
		</div>      
      <br><br>
