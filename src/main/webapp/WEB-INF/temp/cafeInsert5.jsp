...
#room_time:focus ~ .bar:before, input:focus ~ .bar:after {
  width:85%;
...
/*데이터에 저장하기 배열같이 어디 담아둘까? -1018-*/		
	...
	$("#pass_plus").click(function(){
		count++;
		var input = $('<div class="group"></div>').attr("pp_cnt",count);
		var input2 = $('<div class="group"></div>').attr("pn_cnt",count);
		var input_inside = $('<input type="text" id="pass_name" style="width: 400px!important" required><span class="highlight"></span><span class="bar"></span> <label style="font-size: 15px;">이용권 이름</label>');
		var input2_insdie = $(' <input type="text" id="pass_price" style="width: 400px!important; display: inline;" required> <span class="highlight"></span><span class="bar"></span><label style="font-size: 15px;">가격</label>');
	...
	$("#roomName_plus").click(function(){
		rn_cnt++;
		var room_Ndiv = $('<div class="group" id="room_n"></div>').attr("rn_cnt",rn_cnt);
		var room_Ninput = $('<input type="text" id="room_name" style="width: 865px!important; display: inline;" required><span class="highlight"></span><span class="bar"></span><label>룸 이름</label> ')
	...
	$("#room_plus").click(function(){
		var rt_div = $('<input type="text" id="room_time"style="width: 400px!important">');
		var rp_div = $('<input type="text" id="room_price" style="width: 400px!important; display: inline;" required>');
	...
	$("#c_seat").click(function(){
		del();
		$("#c_seat").attr("placeholder","ex)개인좌석이있는 경우만 입력해주세요 130석")
	});
});
</script>
 </head>
                            ...
                            <div class="col-lg-12 ml-auto mr-auto">
                                ...
                                <div class="wizard-content">
                                    ...
                                    <form style="margin-top:30px; ">
										     ...
										     <span class="bar"></span>
										     <label style="font-size: 15px;">카페 이름</label>
										   </div>
      
                                           <div class="group">      
										     <input type="text" id="c_info" required>
										     <span class="highlight"></span>
										     <span class="bar"></span>
										     <label>카페 한줄 소개</label>
										   </div>
                                           	<div class="group">      
										     ...
										     <label>전화번호</label>
                                           	...
                                           	<div class="group">      
										     <input type="text" id="c_time" required>
										     <span class="highlight"></span>
										     <span class="bar"></span>
										     <label>영업시간</label>
										   </div>
                                           	<div class="group">      
										     <input type="text" id="c_seat" required>
										     <span class="highlight"></span>
										     <span class="bar"></span>
										     <label>좌석수</label>
										   </div>
										  	<div class="item_checkbox" style="margin-top: 50px; color: gray;">
										  	<p style="margin-bottom: 30px;"><font>카페의 대표특성 4가지를 선택해주세요!(카페 상세 페이지 최상단에  아이콘으로 노출됩니다!)</font></p>
										...
										<!-- Grid row -->
											  <div class="form-row" style="margin-top: 50px;">
											    ...
											    <div class="col-md-6" id="pass_n">
											      <!-- Material input -->
											     <div class="group">      
												     <input type="text" id="pass_name"style="width: 400px!important" required>
												     <span class="highlight"></span>
												     <span class="bar"></span>
												     <label style="font-size: 15px;">이용권 이름</label>
												   </div>
											    </div>
											    <!-- Grid column -->
										     ...
										     <input type="text" id="pass_price" style="width: 400px!important; display: inline;" required>
										        &nbsp   <i class="fas fa-plus" id="pass_plus">&nbsp</i>
											          <i class="fas fa-minus" id="pass-minus"></i>
										     <span class="highlight"></span>
										     <span class="bar"></span>
										     <label style="font-size: 15px;">가격</label>
											  ...
											  <div class="row">
											    ...
											    <div class="col-md-12"  id="room_n">
											      <!-- Material input -->
											      <div class="group">      
										     <input type="text" id="room_name" style="width: 865px!important; display: inline;" required>
										     ...
										     <label>룸 이름</label>
											  ...
											  <div class="form-row" id="room">
											    <!-- Grid column -->
											    <!-- Grid column -->
											    <div class="col-md-6" id="room_t">
											      <!-- Material input -->
											     <div class="group">      
												     <input type="text" id="room_time"style="width: 400px!important" required>
												     <span class="highlight"></span>
												     <span class="bar"></span>
												     <label style="font-size: 15px;">룸 시간 설정</label>
												   </div>
											    </div>
											    <!-- Grid column -->
											
											    <!-- Grid column -->
											    <div class="col-md-6" id="room_p">
											      <!-- Material input -->
											      <div class="group">      
											      
										     <input type="text" id="room_price" style="width: 400px!important; display: inline;" required>
										        &nbsp   <i class="fas fa-plus" id="room_plus">&nbsp</i>
											          <i class="fas fa-minus" id="room-minus"></i>
										     <span class="highlight"></span>
										     <span class="bar"></span>
										     <label style="font-size: 15px;">시간 별 룸가격</label>
                                    ...
                                    <form style="margin-top: 30px;">
                                           <!--Textarea with icon prefix-->
											<div class="md-form amber-textarea active-amber-textarea-2">
											  <label for="form24" style="position: relative;"><font style="color: gray;">상품정보 제공 고시</font></label>
...
2.기타 간단한 식음료 제공"></textarea>
											...
											<!--Textarea with icon prefix-->
											<div class="md-form amber-textarea active-amber-textarea-2">
											    <label for="form24" style="position: relative;"><font style="color: gray;">취소 및 환불 규정</font></label>
